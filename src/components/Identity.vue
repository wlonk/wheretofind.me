        ...
        <div class="form-group row">
          ...
          <div class="col-sm-9">
            ...
            >
              ...
              <option value="fa fa-codiepie">Codiepie</option>
              ...
              <option value="fa fa-hackster">Hackster</option>
              <option value="fa fa-hashnode">Hashnode</option>
